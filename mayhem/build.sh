...
#   (1) /mayhem/my_basic        — SANITIZED fuzz target (ASan+UBSan halting, by default)
...
# ---------------------------------------------------------------------------
$CC $SANITIZER_FLAGS $DEBUG_FLAGS $UBSAN_RELAX $INCLUDE -Os -c core/my_basic.c $CORE_WARN -o /tmp/my_basic.core.o
$CC $SANITIZER_FLAGS $DEBUG_FLAGS $UBSAN_RELAX $INCLUDE -Os -c shell/main.c    $SHELL_WARN -o /tmp/my_basic.main.o
...
$CC $SANITIZER_FLAGS $DEBUG_FLAGS         -Os -c mayhem/asan_options.c            -o /tmp/my_basic.asan.o
$CC $SANITIZER_FLAGS $DEBUG_FLAGS $UBSAN_RELAX -o /mayhem/my_basic /tmp/my_basic.core.o /tmp/my_basic.main.o /tmp/my_basic.asan.o -lm
